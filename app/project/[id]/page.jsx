...
const Project = async ({ params: { id } }) => {
  ...
  return (
    <Modal>
      <section className="flexBetween w-full max-w-4xl max-xs:flex-col gap-y-8">
        <div className="flex max-xs:flex-col w-full flex-1 items-start gap-5">
      ...
      <section className="flexCenter flex-col mt-20">
        ...
        <div className="flex flex-wrap gap-5 mt-5">
          ...
          <Link
            ...
            className="flexCenter gap-2 text-sm font-medium text-primary-purple"
          >
            🚀 <span className="unedrline">Live Site</span>
          </Link>
        </div>
      </section>
